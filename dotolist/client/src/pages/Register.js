...
const Register = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-accent-50 to-primary-50 dark:from-gray-900 dark:to-gray-800 flex items-center justify-center p-4">
      <button
      ...
      <div className="w-full max-w-md">
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl p-8 animate-fade-in">
          <div className="text-center mb-8">
            ...
            <h1 className="text-2xl font-bold text-gray-900 dark:text-white">Join AlwaysFront</h1>
            <p className="text-gray-500 dark:text-gray-400 mt-2">Start your journey to academic success</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                className="input-field"
                placeholder="john.kamau@students.uonbi.ac.ke"
                required
              />
            </div>
